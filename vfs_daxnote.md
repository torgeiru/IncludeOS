...
4. Type `make` to build qemu and `make virtiofsd` to make VirtioFSD.  
...
```json
{
  "virtiofs_dax" : {
    ...
    "cache_size" : <cache_size_in_#_of_MiBs>,
    "qemu_path" : "<path-to-custom-built-qemu>",
    "virtiofsd_path" : "<path-to-the-custom-built-virtiofsd>"
  }
}
```
